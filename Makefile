# --- Compiler Settings ---
CC = gcc
CFLAGS = -O1 -Wall -std=c99 -Wno-missing-braces -I include/ -I src/ -I src/UI/ -I src/core/ -I src/third_party/
...
SRC = main.c $(wildcard src/core/*.c) $(wildcard src/UI/*.c) src/third_party/cJSON.c
